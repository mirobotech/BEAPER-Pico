...
A MicroPython driver and example programs for use with ST VL53L4CD ToF (Time-of-Flight) LASER distance sensor modules and the BEAPER Pico circuit.
...
* ToF_SONAR_Comparison.py - a demo program using BEAPER Pico's LCD to compare VL53L4CD ToF and HC-SR04P SONAR distance and measurement time with a graphical 'beam' view of the SONAR and ToF sensor ranges plus ranging time readouts.
