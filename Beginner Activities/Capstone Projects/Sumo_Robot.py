...
#               the Pico's on-board LED to show the robot is ready.
...
while True:
    ...
    # --- State: Idle ---
        ...
        # TODO: implement a flashing pattern on the Pico's on-board
        #       LED to show the robot is powered and waiting. Use the
        #       Activity 11 repeating-timer pattern.
...
# --------------------------------------------------------------------------------
#
# BEAPER_Pico.py does not currently provide a VDIV_level() battery
# voltage helper the way BEAPER_Nano.py does. If your BEAPER Pico
# circuit includes a battery voltage divider, you will need to read
# it directly with 'machine.ADC' and scale the result yourself,
# following the same pattern as Q1_level()/Q3_level() in the board
# module. Low battery causes erratic motor behaviour that can look
# like software bugs - print the voltage reading at startup and
# periodically during the match, and add a low-battery warning (beep
# and/or slow flashing LED) if it drops below a threshold you
